/* ============================================================
   ...
   FOUR STAGES IN THE BRIEF ARE NOT IN THIS CATALOGUE. It asks for 6A
   (chord-scale theory), 13 (Mantooth voicings), 15 (constant structures) and
   V1–V3 (scat). This room's ladder is P0 and 1–12, out of Siskind, and
   inventing four stages of exercises to hang metadata on would be inventing
   a curriculum rather than enriching one. Their material is folded into the
   stages that do exist and are about the same thing: the chord-scale
   material into stage 8, the quartal and Mantooth material into 8.3b and
   8.3c, the constant-structure material into 10.4. Nothing is lost; nothing
   is fabricated to hold it.
   ============================================================ */
